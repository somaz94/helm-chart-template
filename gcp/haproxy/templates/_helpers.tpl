...
*/}}
{{- define "staging-haproxy.labels" -}}
helm.sh/chart: {{ include "haproxy.chart" . }}
{{ include "staging-haproxy.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
*/}}
{{- define "staging-haproxy.selectorLabels" -}}
app.kubernetes.io/name: "staging-{{ include "haproxy.name" . }}"
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
